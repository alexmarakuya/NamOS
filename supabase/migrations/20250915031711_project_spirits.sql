...
('discovery', 'Discovery', 'Understanding client needs, requirements gathering, and project scoping', 5, 
 ARRAY['Requirements document', 'Project scope', 'Initial timeline'],
 ARRAY['Clear requirements defined', 'Stakeholders identified', 'Success metrics established'],
 ARRAY['planning']),
 
('planning', 'Planning', 'Detailed project planning, resource allocation, and timeline creation', 3,
 ARRAY['Project plan', 'Resource allocation', 'Detailed timeline', 'Risk assessment'],
 ARRAY['Tasks defined and prioritized', 'Team assigned', 'Timeline approved'],
 ARRAY['design', 'development']),
 
('design', 'Design', 'Creating designs, wireframes, prototypes, and getting client approval', 7,
 ARRAY['Wireframes', 'Design mockups', 'Prototypes', 'Style guide'],
 ARRAY['Designs approved by client', 'Technical feasibility confirmed'],
 ARRAY['development']),
 
('development', 'Development', 'Building the solution, coding, and implementation', 14,
 ARRAY['Core functionality', 'Features implementation', 'Integration work'],
 ARRAY['Key features completed', 'Code quality standards met'],
 ARRAY['testing', 'review']),
 
('testing', 'Testing', 'Quality assurance, bug fixes, and performance optimization', 5,
 ARRAY['Test cases', 'Bug reports', 'Performance metrics', 'Security audit'],
 ARRAY['All critical bugs fixed', 'Performance targets met'],
 ARRAY['review', 'delivery']),
 
('review', 'Review', 'Client review, feedback incorporation, and final adjustments', 3,
 ARRAY['Review sessions', 'Feedback documentation', 'Final adjustments'],
 ARRAY['Client approval received', 'All feedback addressed'],
 ARRAY['delivery']),
 
('delivery', 'Delivery', 'Final delivery, deployment, and handover to client', 2,
 ARRAY['Final deliverables', 'Documentation', 'Training materials', 'Deployment'],
 ARRAY['Solution deployed', 'Client trained', 'Documentation complete'],
 ARRAY['maintenance']),
 
('maintenance', 'Maintenance', 'Ongoing support, updates, and maintenance', 30,
 ARRAY['Support documentation', 'Update schedule', 'Monitoring setup'],
 ARRAY['Support processes established', 'Client satisfied with ongoing service'],
 ARRAY[]::TEXT[])
